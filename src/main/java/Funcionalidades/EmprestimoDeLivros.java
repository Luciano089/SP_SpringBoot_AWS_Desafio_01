...
public class EmprestimoDeLivros {
    ...
    public void realizarEmprestimo(Emprestimo emprestimo) throws ParseException {
        ...
        if (livrosDisponiveis.isEmpty()) {
            ...
            TypedQuery<Membro> query = GerenciadorDeEntidade.createQuery("SELECT membro FROM Membro membro WHERE membro.nome = :nome", Membro.class);
            ...
            emprestimo.setDataDevolucao(Date.valueOf(localDate));

            GerenciadorDeEntidade.persist(emprestimo);
            GerenciadorDeEntidade.getTransaction().commit();

            System.out.println("O emprestimo foi concluido");
